...
const Home = () => {
  return (
    <section id="home" className="bg-contain bg-right media830:bg-contain pt-36 px-6 md:px-12 max-w-[1440px] mx-auto" style={{backgroundImage : `url(${homeBg})`}}>
      <div className="flex flex-col media830:flex-row media830:items-center justify-between max-w-6xl mx-auto ">
        ...
        <div>
          <img className="w-full max-w-[100px] media321:max-w-[150px] media450:max-w-[430px] media830:max-w-xl ml-16 media450:ml-0" src={whiteShoe} alt="white shoe"/>
        </div>
      </div>
    </section>
  )
